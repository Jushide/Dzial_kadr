...
<body>
    ...
    <div class="container">
        <h2 id="list-head">Lista płac pracowników</h2>
            ...
            <table>
                ...
                <?php
                    ...
                    while($rows=$result->fetch_assoc())
                    {
                        ...
                        $Pensja = $rows['Pensja'];
                        $Premia = $rows['Premia'];
                        $Prowizje = $rows['Prowizje'];
                        $Dodatek = $rows['Dodatek_stazowy'];

                        if($rows['Czy_zatrudniony']=="Tak"){
                ?>
                <tr>
                    <td><?php echo $number++; ?></td>
                    <td><?php echo "<span class='name'>" . $rows['Imie'] . " " . $rows['Nazwisko'] . "</span>";?></td>

                    <td><?php echo $rows['Stanowisko'];?></td>
                    <td><?php echo $rows['Dzial'];?></td>
                    <td><?php echo $Pensja;?></td>
                    <td><?php echo $Premia;?></td>
                    <td><?php echo $Prowizje;?></td>
                    <td><?php echo $rows['Dodatek_stazowy'];?></td>
                    <td>
                        <?php
                            $razem = $Pensja + $Premia + $Prowizje;
                            echo $razem;
                        ?>
                    </td>
                </tr>
        ...
        <div class="menu">
            ...
            <div class="item">
                ...
                <div class="sub-menu">
                    ...
                    <a href="#" class="sub-item"> Lista kandydatów </a>
            ...
            <div class="item">
                ...
                <div class="sub-menu">
                    ...
                    <div class="sub-menu2">
                        ...
                        <a href="Zst_firmy.php" class="sub-item" style="color: #3056ff; background: #fff; border: 2px solid #3056ff"> Całej firmy </a>
                    </div>
