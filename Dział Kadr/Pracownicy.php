...
<body>
    ...
    <div class="container">
        <h2 id="list-head">Lista pracowników</h2>
        <div style="overflow-x: auto">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <div class="avatar centering"></div>
                    </td>
                    ...
                    <td><?php echo $rows['Pensja'];?></td>
                    <td><?php echo $rows['Premia'];?></td>
                    <td><?php echo $rows['Prowizje'];?></td>
                    <td><?php echo $rows['Ubezpieczenie'];?></td>
    ...
    <div class="adding">
        <a href="Formularz_Dodaj.php"><input type="button" value="Dodaj pracownika" id="add" /></a>
    </div>
    <div class="side-bar" id="side">
        ...
        <div class="menu">
            ...
            <div class="item">
                ...
                <div class="sub-menu">
                    <a href="#" class="sub-item" style="color: #3056ff; background: #fff; border: 2px solid #3056ff">
                        Lista pracowników
                    </a>
